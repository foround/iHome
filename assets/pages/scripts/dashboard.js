var Dashboard = function() {
    ...
    var weekOfStart = getMonday(new Date()); // 获得本周周一
    weekOfStart.setHours(0);
    weekOfStart.setMinutes(0);
    weekOfStart.setSeconds(0);
    weekOfStart.setMilliseconds(0);
    console.log(weekOfStart);
    weekOfStart = weekOfStart.getTime();//转换毫秒

    var firstDayOfMonth = new Date();
    firstDayOfMonth = new Date(firstDayOfMonth.getFullYear(), firstDayOfMonth.getMonth(), 1);
    firstDayOfMonth = firstDayOfMonth.getTime();
    ...
    $.ajax({
        type: "POST",
        url: "http://www.qhiehome.com:8080/web/api/admin/income",
        data: { startTime: dateOfToday, endTime: now},
        dataType: "json",
        success: function (data) {
            console.log(data);
            var temp = data.data;
            var code = data.errcode;
            var flag = isEmptyObject(temp);
            var sum = temp.sum;
            if (flag) {
                sum = 0;
            }
            console.log(temp);
            if (code == 1) {
                $('#realTimeIncome').attr("data-counter", "counterup");
                $('#realTimeIncome').attr("data-value", sum);

                $('#realTimeIncome').counterUp({
                    delay: 1,
                    time: 1000
                });

               /* $('#realIncomeWidth').css('width','5%');
                $('#realIncomePercent').html('5%');*/
    ...
    $.ajax({
        type: "POST",
        url: "http://www.qhiehome.com:8080/web/api/admin/income",
        data: { startTime: weekOfStart, endTime: now},
        dataType: "json",
        success: function (data) {
            console.log(data);
            var temp = data.data;
            ...
            console.log(code);
            if (code == 1) {
                $('#weekIncome').attr("data-counter", "counterup");
                $('#weekIncome').attr("data-value", sum);


                $('#weekIncome').counterUp({
                    delay: 1,
                    time: 1000
                });

               /* $('#weekWidth').css('width','5%');
                $('#weekIncomePercent').html('5%');*/
    ...
    $.ajax({
        type: "POST",
        url: "http://www.qhiehome.com:8080/web/api/admin/income",
        data: { startTime: firstDayOfMonth, endTime: now},
        dataType: "json",
        success: function (data) {
            console.log(data);
            var temp = data.data;
            ...
            console.log(code);
            if (code == 1) {
                $('#monthIncome').attr("data-counter", "counterup");
                $('#monthIncome').attr("data-value", sum);

                $('#monthIncome').counterUp({
                    delay: 1,
                    time: 1000
                });

              /*  $('#monthWidth').css('width','5%');
                $('#monthIncomePercent').html('5%');*/
    ...
    $.ajax({
        type: "POST",
        url: "http://www.qhiehome.com:8080/web/api/admin/income",
        data: { startTime: firstDayOfYear, endTime: now},
        dataType: "json",
        success: function (data) {
            console.log(data);
            var temp = data.data;
            ...
            console.log(code);
            if (code == 1) {
                $('#yearIncome').attr("data-counter", "counterup");
                $('#yearIncome').attr("data-value", sum);

                $('#yearIncome').counterUp({
                    delay: 1,
                    time: 1000
                });

             /*   $('#yaerWidth').css('width','5%');
                $('#yearIncomePercent').html('5%');*/
    ...
    return {
        ...
        initAmChart1: function() {
            ...
            var endTimeOfUpdate = new Date();
            endTimeOfUpdate = endTimeOfUpdate.getTime();
            var startTimeOfUpdate = endTimeOfUpdate - 100000000000;
            console.log(startTimeOfUpdate);
            $.ajax({
                type: "POST",
                url: "http://www.qhiehome.com:8080/web/api/admin/income",
                data: { startTime: startTimeOfUpdate, endTime: endTimeOfUpdate},
                dataType: "json",
                success: function (data) {
                    console.log(data)
                    var code = data.errcode;
            ...
            var chart = AmCharts.makeChart("dashboard_amchart_1", {
                ...
                graphs: [{
                    ...
                    legendPeriodValueText: "总收入: [[value.sum]] 元",
                    lineColor: "#08a3cc",
                    alphaField: "alpha"
                }, {
                    id: "g2",
